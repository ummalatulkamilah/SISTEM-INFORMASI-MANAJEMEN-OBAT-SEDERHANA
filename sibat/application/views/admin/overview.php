        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h4 mb-0 text-grey-400">Dashboard</h1>
          </div>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-success shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Obat yang hampir habis (stok < 10)</div>
                      <?php foreach($stok as $s){ ?> 
                      <div class="h6 mb-0 text-gray-800"> <?php echo $s ;?></div>
                      <?php } ?>
                    </div>
                    <div class="col-auto">
                      <i class="fas fa-ceklist fa-2x text-gray-300"></i>
                    </div>
                  </div>
                </div>
              </div>
